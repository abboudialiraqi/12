...
const SETTING_SECTIONS: SettingSection[] = [
  ...
  },
  {
    ...
    desc: 'نصوص وصور خلفية الشرائح الثلاثة في أعلى الصفحة',
    icon: Globe,
    color: 'text-sky-600 bg-sky-50',
    fields: [
      { key: 'banner1_img', label: 'الشريحة 1 — صورة الخلفية (رابط URL)', placeholder: 'https://images.pexels.com/...', ltr: true },
      { key: 'banner1_bg',  label: 'الشريحة 1 — ألوان التدرج (Tailwind)', placeholder: 'from-emerald-600 to-teal-700', ltr: true },
      { key: 'banner2_img', label: 'الشريحة 2 — صورة الخلفية (رابط URL)', placeholder: 'https://images.pexels.com/...', ltr: true },
      { key: 'banner2_bg',  label: 'الشريحة 2 — ألوان التدرج (Tailwind)', placeholder: 'from-sky-700 to-blue-800', ltr: true },
      ...
      { key: 'banner3_bg',  label: 'الشريحة 3 — ألوان التدرج (Tailwind)', placeholder: 'from-amber-600 to-orange-700', ltr: true },

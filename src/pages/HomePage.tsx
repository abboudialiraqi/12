  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-6">
        <div className="bg-gradient-to-l from-red-600 to-rose-700 rounded-2xl p-5 flex items-center justify-between overflow-hidden relative">
          <div className="absolute -right-8 -top-8 w-32 h-32 bg-white/10 rounded-full" />
          <div className="absolute -left-4 -bottom-4 w-24 h-24 bg-white/10 rounded-full" />
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center group">
              <Zap className="w-6 h-6 text-yellow-300 fill-yellow-300 group-hover:scale-110 transition-transform" />
            </div>
            <div>
              <p className="text-white font-bold text-lg">عروض اليوم الحصرية</p>
              <p className="text-red-200 text-sm">خصومات تصل إلى 30% على منتجات مختارة</p>
            </div>
          </div>
          <div className="flex items-center gap-3 relative z-10">
            <button
              onClick={onSaleNavigate}
              className="px-5 py-2.5 bg-white text-red-600 rounded-xl text-sm font-bold hover:bg-red-50 active:scale-[0.98] transition-all shrink-0"
            >
              تسوق الآن
            </button>
          </div>
